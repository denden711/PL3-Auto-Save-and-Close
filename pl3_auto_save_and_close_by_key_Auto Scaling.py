...
def execute_pl3_and_save(file_path, log_file_path, wait_time=5, retry_limit=3):
    ...
    try:
        ...
        time.sleep(0.5)
        pyautogui.press('space')  # スペースキー
        time.sleep(0.5)
        pyautogui.press('tab', presses=2, interval=0.2)  # Tab キーを2回
        time.sleep(0.5)
        pyautogui.press('space')  # スペースキー
        time.sleep(0.5)
        pyautogui.press('tab')  # Tab キーを1回
        time.sleep(0.5)
        pyautogui.press('space')  # スペースキー
        time.sleep(0.5)
        pyautogui.press('enter')  # Enter キー
        time.sleep(1)
        pyautogui.hotkey('ctrl', 'y')  # Ctrl + Y
        time.sleep(0.5)
        pyautogui.press('tab', presses=2, interval=0.2)  # Tab キーを2回
        time.sleep(0.5)
        pyautogui.press('0')  # 0 キー
        time.sleep(0.5)
        pyautogui.press('enter')  # Enter キー
        time.sleep(1)
